...
set_property PACKAGE_PIN T3 [get_ports {in3[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {in3[0]}]
set_property PACKAGE_PIN T2 [get_ports {in3[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {in3[1]}]
set_property PACKAGE_PIN R3 [get_ports {in3[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {in3[2]}]
set_property PACKAGE_PIN W2 [get_ports {threshold[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {threshold[0]}]
set_property PACKAGE_PIN U1 [get_ports {threshold[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {threshold[1]}]
set_property PACKAGE_PIN T1 [get_ports {threshold[2]}]					
